...
is(frac_approx('-0.6180339887'),    '-260497/421493');
is(frac_approx('1.008155930329'),   '7293/7234');
is(frac_approx('1.0019891835756'),  '524875/523833');
is(frac_approx('-529.12424242424'), '-174611/330');

is(frac_approx($o->new_q(1,  6)->as_dec),  '1/6');
is(frac_approx($o->new_q(13, 6)->as_dec),  '13/6');
is(frac_approx($o->new_q(6,  13)->as_dec), '6/13');

is(frac_approx($o->new_f('-5.0108932461873638344226579520697167755991285403')), '-2300/459');
is(frac_approx($o->new_f('-5.0544662309368191721132897603485838779956427015')), '-2320/459');
