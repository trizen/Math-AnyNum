...
The following functions are exportable:
    ...
    :ntheory
        ...
        iroot isqrt icbrt ilog ilog2 ilog10 isqrtrem
        irootrem powmod invmod is_power is_square
        is_prime is_coprime next_prime
...
Raises C<2> to the power C<n>, truncating C<n> to an integer.
...
Raises C<10> to the power C<n>, truncating C<n> to an integer.
Returns C<0> when C<n> is negative.
