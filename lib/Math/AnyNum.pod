...
The following functions are exportable:
    ...
    :misc
        ...
        as_oct as_int as_float as_frac is_pos is_neg
        is_int is_rat is_real is_imag is_complex is_inf
...
=head2 as_float
    ...
    as_float(n)                                   #=> Scalar
    as_float(n, digits)                           #=> Scalar

Returns a decimal expansion as a string, representing  the number C<n>,
with an optional number of digits. When the second argument is undefined,
