...
The following functions are exportable:
    ...
    :ntheory
        ...
        is_polygonal is_prime is_coprime next_prime
        polygonal ipolygonal_root rising_factorial
        falling_factorial
...
Example:
    ...
    say ipolygonal_root($n, 3);                  # triangular root
...
Example:
    ...
    # Hexagonal (6-gonal) numbers in the range [1, 100]
    say join(' ', grep { is_polygonal($_, 6) } 1..100);
